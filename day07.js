...
function getMinFuel(values, fuelFn = d=>d) {
  let histogram = new Map();
  let minPos = Infinity;
  let maxPos = -Infinity;
  for (const value of values) {
    histogram.set(value, histogram.has(value) ? histogram.get(value)+1 : 1);
...
console.assert(getMinFuel(testInput) === 37);
...
*/
function getFuelSum(distance) {
  return ((distance+1) * distance) / 2;
}
console.assert(getFuelSum(1) === 1);
console.assert(getFuelSum(2) === 3);
console.assert(getFuelSum(3) === 6);
console.assert(getFuelSum(4) === 10);
console.assert(getFuelSum(5) === 15);
console.assert(getFuelSum(9) === 45);
console.assert(getFuelSum(11) === 66);
console.assert(getMinFuel(testInput, getFuelSum) === 168);
console.log(getMinFuel(dayInput, getFuelSum));
